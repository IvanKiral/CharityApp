...
val TextFieldBorder = Color(0xFFDEDEDE)
val ProfileIconBorder = Color(0xFFC1C1C1)

val TextDonationGray = Color(0xFF9B9B9B)
val TextBadgesTitle = Color(0xFF94A0AF)
val TextShowBadges = Color(0xFFB7C1CC)
val TextBoxBlackTitle = Color(0xFF5A6470)
val TextBoxBlackSubTitle = Color(0xFF4B5564)
